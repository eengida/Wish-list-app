            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.statsContainer}>
                    <View style={styles.statsBox}>
                        ...
                        <Text style={[styles.text, styles.subText]}>Wish-list items</Text>
                    </View>
                ...
                <View style={{ alignItems: "center" }}>
                    <View style={styles.recentItem}>
                        ...
                        <View style={{ width: 250 }}>
                            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                                 Items <Text style={{ fontWeight: "400" }}>Shoes for hanna</Text> and <Text style={{ fontWeight: "400" }}>Luis Poteer</Text>
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.recentItem}>
                        ...
                        <View style={{ width: 250 }}>
                            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                                Liked <Text style={{ fontWeight: "400" }}>Luke's Wish-list</Text>
                            </Text>
                        </View>
                    </View>
                </View>
